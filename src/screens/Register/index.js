      ...
      >
        <div className="w-full h-full p-6 flex flex-col items-center justify-center">
          ...
          <form onSubmit={handleSubmit} className="w-full">
            <Input
              error={touched.name ? errors.name : null} // Exibe erro apenas se o campo foi tocado
            ...
            />
            <Input
              error={touched.email ? errors.email : null} // Exibe erro apenas se o campo foi tocado
              onChange={handleChange}
              value={values.email}
              id="email"
              name="email"
            ...
            <Button
              ...
              type="submit"
              className="mt-4 mb-10 max-2xl:mt-6 max-2xl:mb-10 max-xl:mt-6 max-xl:mb-10 max-lg:mt-6 max-lg:mb-10 max-md:mt-6 max-md:mb-8 max-sm:mt-4 max-sm:mb-6"
            >
